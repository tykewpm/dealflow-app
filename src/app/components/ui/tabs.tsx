...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        'inline-flex h-9 w-fit flex items-center justify-center rounded-xl border border-border-subtle bg-bg-elevated/80 p-[3px] text-text-muted dark:bg-bg-elevated/50',
        className,
      )}
      {...props}
    />
